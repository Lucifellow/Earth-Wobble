...
public class QueryUtils {
    ...
    /**
     * Return a list of {@link EarthWobble} objects that has been built up from
     * parsing a JSON response.
     */
    public static ArrayList<EarthWobble> extractEarthquakes() {

        // Create an empty ArrayList that we can start adding earthquakes to
        ArrayList<EarthWobble> earthquakes = new ArrayList<>();
        ...
        try {
            ...
            for(int i=0;i<earthquakeArray.length();i++){
                ...
                EarthWobble earthquake=new EarthWobble(magnitude,location,time);
